      ...
      <div className="lesson-header">
        <button className="back-button" onClick={async () => {
          try {
            const user = authService.getCurrentUser();
            if (user && stageTimer > 0) {
              await userProgressService.updateStageTime(user.uid, 'AZWords', stageTimer).catch(e => console.warn(e));
            }
          } catch (e) {
      ...
      {showCelebration && (
        <div className="celebration-modal">
          <div className="celebration-content" style={{ maxWidth: '400px', padding: '15px' }}>
            ...
            <p style={{ fontSize: '0.9rem', marginBottom: '5px' }}>Word completed!</p>
            <div className="celebration-word" style={{ fontSize: '2.5rem', color: '#667eea', margin: '5px 0' }}>{currentword}</div>
        ...
        <div className="stage-complete-modal">
          ...
          <div className="stage-complete-content">
            ...
            <div className="badge-awarded" style={{ background: '#FFF5F5', padding: '10px', borderRadius: '12px', marginBottom: '15px' }}>
              <img src="/assets/badges/badge_az_word_master.png" alt="A-Z Word Master Badge" className="badge-icon-img" style={{ width: '50px', height: '50px', marginBottom: '5px' }} />
              <p style={{ fontSize: '0.9rem', color: '#2D3748', margin: '0' }}>You received the <strong>A-Z Word Master</strong> badge!</p>
            </div>
