...
const CameraFeed = ({ currentLetter, currentDay, currentWord, onPrediction, predictionService: customPredictionService, useWebSocket = true, hideOverlay = false, featureSize = 126 }) => {
  ...
  // Use provided service, fallback to default alphabet service
  ...
  const handleResults = (results) => {
    ...
    const { features, leftDetected, rightDetected } = buildFeatureVector(results, featureSize);
